...
-->
    <div class='title-box'>
        <a href="<?php echo URL; ?>">Dnd Application</a>
    </div>
    ...
    <div class="header">
		...
		<!--
            ...
            <li <?php if ($this->checkForActiveController($filename, "Characters")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>Characters/index">Characters</a>
            </li>
			<?php endif; ?>
			<?php if (Session::get('user_logged_in') == true):?>
			<li <?php if ($this->checkForActiveController($filename, "Hex_Map")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>Hex_Map/index">Hex Map</a>
            </li>
			<?php endif; ?>
			<!--
            ...
            <li <?php if ($this->checkForActiveController($filename, "admin")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>admin/index">Admin Section</a>
				<ul class="sub-menu">
                        <li <?php if ($this->checkForActiveController($filename, "admin/users")) { echo ' class="active" '; } ?> >
                            <a href="<?php echo URL; ?>admin/users">Users</a>
                        </li>
						<li <?php if ($this->checkForActiveController($filename, "admin")) { echo ' class="active" '; } ?> >
                            <a href="<?php echo URL; ?>admin/characters">Characters</a>
                        </li>
						<!--  
        ...
        <?php if (Session::get('user_logged_in') == true): ?>
            <div class="header_right_box">
				<ul id="menu">
				<li <?php if ($this->checkForActiveController($filename, "login")) { echo ' class="active" '; } ?> >
                    <a href="<?php echo URL; ?>login/showprofile" style="padding:0px">
					<div class="namebox">
