...
<?php
	echo "<a href='/test.php'>Back to Group </a>";
        echo "<a href='/Character.php?ID=" .$_GET["ID"] . "'>Back to Character Sheet</a>";
...
if ($result->num_rows > 0) {
	...
	echo "<div style='display:inline;'><a href=Item.php?ID=".$row["Item_ID"]."&PL_ID=".$_GET["ID"].">" . $row["Name"] . "<div></td>
	<td>".($row["Weight"]/16)."</td>
	<td>";
